  ...
  return (
    <>
     <div className='main_nav sticky w-full h-14 flex items-center px-7 justify-between sm:bg-yellow-400/0 md:bg-red-400 md:px-4 lg:bg-zinc-700/0'>
          ...
          <div className=' w-[70vw] max630_hide sm:flex items-center gap-8 justify-end sm:gap-4 md:gap-4 lg:gap-8'>
          ...
          <div className=' sm:hidden menu_bar3line'><i class="ri-menu-4-line"></i></div>
     </div>
    </>
  )
}
