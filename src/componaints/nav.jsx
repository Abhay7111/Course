...
function Nav() {
  return (
    <>
     <div className=' sticky w-full h-14 flex items-center px-7 justify-between sm:bg-yellow-400/0 md:bg-red-400 md:px-4 lg:bg-zinc-700/0'>
          <div className="logo text-[1.8rem] font-bold w-12 break-words leading-[23px] sm:scale-[1.2] sm:mt-3">PLICK</div>
          <div className=' w-[70vw] flex items-center gap-8 justify-end sm:gap-4 md:gap-4 lg:gap-8'>
